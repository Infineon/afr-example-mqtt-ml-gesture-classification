...
*
*******************************************************************************/
void control(MTB_ML_DATA_T* result_buffer, int model_output_size, gesture_t* detected_gesture)
{
    ...
    if(MIN_CONFIDENCE < nn_float_buffer[class_index])
    {
        ...
        switch (class_index)
        {
            case 0:
                printf("Square\r\n");
                *detected_gesture = GESTURE_SQUARE;
                break;
            case 1:
                printf("Circle\r\n");
                *detected_gesture = GESTURE_CIRCLE;
                break;
            case 2:
                printf("Side-To-Side\r\n");
                *detected_gesture = GESTURE_SIDE_TO_SIDE;
                break;
            case 3:
                printf("None\r\n");
